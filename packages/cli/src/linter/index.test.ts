...
describe('Integration: full pipeline', () => {
  it('processes a frontmatter design-specs through the complete pipeline', () => {
    const content = `---
name: Kindred Spirit
...
`;
  ...
  it('processes a code-block design-specs with components', () => {
...
`;
  ...
  it('correctly detects errors in a broken design-specs', () => {
    const content = `---
colors:
  primary: "#647D66"
