# design-specs Philosophy

design-specs captures how a design looks, feels, and behaves. The prose is where the design lives. Everything else in the document exists to support it.
...
design-specs contains two primary aspects: tokens and prose. The specification is focused on describing this design context to keep designs consistent between generations and to provide an area of creative exploration. The prose is the most vital part of the specification. 
...
This keeps tokens as context that serves as a reference in the prose and focuses design-specs on documenting the nature of the design and not trying to reinvent the decades long work established by languages and tools that came before us.

This document communicates the narrative and philosophy of design-specs to clarify what problems it solves and how it currently attempts to solve them.
